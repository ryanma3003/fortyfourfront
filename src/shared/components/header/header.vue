                        ...
                        <template v-if="showSuggestions">
                            <div
                                ...
                                <div class="card-header">
                                    <div class="card-title mb-0 text-break">Search result of {{ search }}</div>
                                </div>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">
                                    ...
                                    <span class="light-layout" @click="colorthemeFn('dark')">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="header-link-icons" viewBox="0 0 256 256">
                                            <rect width="256" height="256" fill="none" />
                                            <path d="M108.11,28.11A96.09,96.09,0,0,0,227.89,147.89,96,96,0,1,1,108.11,28.11Z" opacity="0" />
                                            <path d="M108.11,28.11A96.09,96.09,0,0,0,227.89,147.89,96,96,0,1,1,108.11,28.11Z" fill="none" stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="20" />
                                        </svg>
                    ...
                    <div class="input-group">
                        ...
                        <template v-if="showSuggestions">
                            <div
                                ...
                                <div class="card-header">
                                    <div class="card-title mb-0 text-break">Search result of
                                        <b><u>{{ search }}</u></b>
                                    </div>
                                </div>
                                <div class="card-body overflow-auto">
...
const ToggleMenu = () => {
    ...
    if (window.innerWidth <= 992) {
        ...
        if (dataToggled === "icon-click-closed") {
            ...
            document.querySelectorAll(".slide.open, .sub-slide.open").forEach(el => {
                el.classList.remove("open");
            });
            document.querySelectorAll(".slide-menu, .sub-slide-menu").forEach(el => {
