...
<aside class="app-sidebar sticky" id="sidebar">
    ...
    <PerfectScrollbar class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul v-if="false" class="doublemenu_bottom-menu main-menu mb-0 border-top">
                <!-- Start::slide -->
                <li class="slide">
      ...
      if (item === targetObject) {
        if (html.getAttribute('data-vertical-style') == 'doublemenu') {
          ...
          if (isChildFlag) {
            ...
            // For parent items in double menu, toggle active state
    ...
    for (const mutation of mutationsList) {
      if (mutation.type === 'attributes' && mutation.attributeName === 'data-nav-layout') {
        ...
        if (newValue === 'vertical') {
          closeMenuFn(); // tutup semua menu
          setMenuActiveByRoute(); // buka menu sesuai path router
        }
