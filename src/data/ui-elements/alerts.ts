...
const svg1 = `<svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000" data-v-f48b4b1f=""><path d="M0 0h24v24H0V0z" fill="none" data-v-f48b4b1f=""></path><path d="M11 7h2v2h-2zm0 4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" data-v-f48b4b1f=""></path></svg>`

const svg2 = `<svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000" data-v-f48b4b1f=""><path d="M0 0h24v24H0V0zm0 0h24v24H0V0z" fill="none" data-v-f48b4b1f=""></path><path d="M16.59 7.58L10 14.17l-3.59-3.58L5 12l5 5 8-8zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z" data-v-f48b4b1f=""></path></svg>`

const svg3 = `<svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000" data-v-f48b4b1f=""><g data-v-f48b4b1f=""><rect fill="none" height="24" width="24" data-v-f48b4b1f=""></rect></g><g data-v-f48b4b1f=""><g data-v-f48b4b1f=""><g data-v-f48b4b1f=""><path d="M12,5.99L19.53,19H4.47L12,5.99 M12,2L1,21h22L12,2L12,2z" data-v-f48b4b1f=""></path><polygon points="13,16 11,16 11,18 13,18" data-v-f48b4b1f=""></polygon><polygon points="13,10 11,10 11,15 13,15" data-v-f48b4b1f=""></polygon></g></g></g></svg>`

const svg4 = `<svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000" data-v-f48b4b1f=""><g data-v-f48b4b1f=""><rect fill="none" height="24" width="24" data-v-f48b4b1f=""></rect></g><g data-v-f48b4b1f=""><g data-v-f48b4b1f=""><g data-v-f48b4b1f=""><path d="M15.73,3H8.27L3,8.27v7.46L8.27,21h7.46L21,15.73V8.27L15.73,3z M19,14.9L14.9,19H9.1L5,14.9V9.1L9.1,5h5.8L19,9.1V14.9z" data-v-f48b4b1f=""></path><rect height="6" width="2" x="11" y="7" data-v-f48b4b1f=""></rect><rect height="2" width="2" x="11" y="15" data-v-f48b4b1f=""></rect></g></g></g></svg>`

const Asvg = `<svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M11 7h2v2h-2zm0 4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path></svg>`

const Asvg1 = `<svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0V0zm0 0h24v24H0V0z" fill="none"></path><path d="M16.59 7.58L10 14.17l-3.59-3.58L5 12l5 5 8-8zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"></path></svg>`

const Asvg2 = `<svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><g><rect fill="none" height="24" width="24"></rect></g><g><g><g><path d="M12,5.99L19.53,19H4.47L12,5.99 M12,2L1,21h22L12,2L12,2z"></path><polygon points="13,16 11,16 11,18 13,18"></polygon><polygon points="13,10 11,10 11,15 13,15"></polygon></g></g></g></svg>`

const Asvg3 = `<svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><g>
...
interface CustomizedAlertType {
    id: number;
    class1: string;
    color: string;
}

interface ImageAlertType {
    id: number;
    src1: string;
    color: string;
    class: string;
...
interface AdditionalContentAlertType {
    id: number;
    text1: string;
    text2: string;
    text3: string;
...
export let
    ...
    Roundedoutlinealerts: AlertType[] = [
    ...
    Customizedalert1: CustomizedAlertType[] = [
    ...
    avatarsizealert: ImageAlertType[] = [
    ...
    Additionalcontentalerts: AdditionalContentAlertType[] = [
