...
const columnLabels = {
    ...
    poin_ikas: 'Poin IKAS',
    poin_kse: 'Poin KSE',
    poin_survey: 'Poin Survey',
    poin_csirt: 'Poin CSIRT',
    nama_se: 'Nama SE',
...
const columnIcons = {
    ...
    persentase: 'ri-percent-line',
    total_poin: 'ri-vip-crown-line',
    poin_ikas: 'ri-star-line',
    poin_kse: 'ri-checkbox-circle-line',
    poin_survey: 'ri-file-list-3-line',
    poin_csirt: 'ri-shield-check-line',
